...
class DeletedComboScreen extends StatefulWidget {
  const DeletedComboScreen({super.key});

  @override
  State<DeletedComboScreen> createState() => _DeletedComboScreenState();
}

class _DeletedComboScreenState extends State<DeletedComboScreen> {
  ...
  Future<void> deleteCoures(courseId) async {
    FirebaseFirestore.instance.collection('combos').doc(courseId).delete();
  }
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: 'Enter combo id to search',
                            hintStyle: TextStyle(
