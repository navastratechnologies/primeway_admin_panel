  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        children: [
         courses2(context), courses2(context), courses2(context), courses2(context),
          ...
          child: Row(
            children: [
              Container(
                height: 200,
                width: 200,
                child: Image.asset('assets/ee-1.jpg',fit: BoxFit.fill,),
              ),
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextButton(onPressed: (){
                       Navigator.push(
    context,
    MaterialPageRoute(builder: (context) => UploadCoursesScreen()),
  );
                    }, child: Text(
                      'Lessons',
                      style: TextStyle(
