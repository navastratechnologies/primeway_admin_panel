...
class _AdminPanelBodyState extends State<AdminPanelBody> {
            ...
            children: [
              Column(
                ...
                children: [
                  ...
                  ScreenTypeLayout(
                    mobile: adminTabel(context, displayWidth(context) / 2),
                    tablet: adminTabel(context, displayWidth(context) / 1.1),
                    desktop: adminTabel(context, displayWidth(context) / 1.8),
                  ),
                ],
              ),
            ],
  ...
  adminTabel(BuildContext context, width) {
    return Container(
      width: width,
      decoration: BoxDecoration(
        color: whiteColor,
